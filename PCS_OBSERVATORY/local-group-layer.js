(function exposeLocalGroupLayer(global) {
  ...
  class LocalGroupLayer{
    ...
    unload(){for(const key of ["points","labels","uncertainties","boundary"]){if(this[key]){this.viewer.scene.primitives.remove(this[key]);this[key]=null;}}this.records=[];this.visible=false;}
