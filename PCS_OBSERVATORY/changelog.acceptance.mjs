...
assert(initial.collapsed && initial.version === "v2.1.0", "collapsed version summary");
await screenshot("01-collapsed-latest");
...
await screenshot("02-expanded-latest");
...
await screenshot("03-mobile-390x844");
