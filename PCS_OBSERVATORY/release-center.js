(function initializeReleaseCenter() {
  ...
  (async () => {
    try {
      ...
      try { expanded = sessionStorage.getItem("pcs-release-center-expanded") === "true"; } catch {}
      panel.hidden = false;
      panel.classList.toggle("is-collapsed", !expanded);
      toggle.setAttribute("aria-expanded", String(expanded));
      render();
