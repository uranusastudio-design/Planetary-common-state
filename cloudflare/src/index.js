...
const EXTRA_STATIC_OBSERVATIONS = [
  { symbol: "SST", value: null, timestamp: new Date().toISOString(), source: "NOAA OISST", note: "registered_pending_connector" },
  { symbol: "GMSL", value: null, timestamp: new Date().toISOString(), source: "NASA Sea Level", note: "registered_pending_connector" },
  { symbol: "OHC", value: null, timestamp: new Date().toISOString(), source: "NOAA Ocean Heat Content", note: "registered_pending_connector" },
  { symbol: "ARCTIC_ICE", value: null, timestamp: new Date().toISOString(), source: "NSIDC Sea Ice", note: "registered_pending_connector" },
  { symbol: "NDVI", value: null, timestamp: new Date().toISOString(), source: "NASA MODIS NDVI", note: "registered_pending_connector" },
  { symbol: "FIRE", value: null, timestamp: new Date().toISOString(), source: "NASA FIRMS", note: "registered_pending_connector" },
  { symbol: "POP", value: null, timestamp: new Date().toISOString(), source: "World Bank Population", note: "registered_pending_connector" },
  { symbol: "ENERGY", value: null, timestamp: new Date().toISOString(), source: "Energy Institute", note: "registered_pending_connector" }
];
