...
const OBSERVATION_LAYER_ADAPTERS = Object.freeze([
  ...
  { id: "wildfire", provider: "NASA FIRMS", dataset: "VIIRS NOAA-20 Near Real-Time active fire detections", endpoint: "https://firms.modaps.eosdis.nasa.gov/api/area/csv/{FIRMS_MAP_KEY}/VIIRS_NOAA20_NRT/world/1", parser: "firms", secret: "FIRMS_MAP_KEY", timeout_ms: 45000, retry_attempts: 2, spatial_resolution: "375 m detection", temporal_resolution: "near real-time", license: PUBLIC_DOMAIN },
