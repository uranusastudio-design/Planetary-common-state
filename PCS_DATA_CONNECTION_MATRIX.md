...
| Global Mean Sea Level | Ocean | NOAA LSA | RELEASE_CANDIDATE | 1,557 | 2025-02-16 | public CSV | acknowledgment recorded | `/api/layers` evidence binding runtime-tested | TBD | Local endpoint/cache/expiry/stale/retry/timeout/browser/console/network passed | Production still serves old Honolulu tide gauge; deployment requires approval |
| NSIDC Sea Ice | Cryosphere | NOAA/NSIDC G02135 v4 | RELEASE_CANDIDATE | 31,614 | 2026-08-12 | public CSV | citation recorded | `/api/layers` evidence binding runtime-tested | TBD | Local endpoint/cache/expiry/stale/retry/timeout/both hemispheres/browser/console/network passed | Production currently serves Arctic only; deployment requires approval |
